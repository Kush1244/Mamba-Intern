...
class Mamba(nn.Module):
    ...
    def from_pretrained(pretrained_model_name: str):
        ...
        if pretrained_model_name not in availableModels:
            print(pretrained_model_name, " not in pretrained model list")
            print("choose any one of the following", end="\n\t")
            for i in availableModels:
                print(i, end="\n\t")
            exit(1)
